...
##### Data name
If you want mrap to extract the data name from the ``code_string``, please indicate it as 'data = my_name', although many R packages also allow for merely 'my_name'. If the data name is not detected, it can be added manually to the instance (see Modify the instance). 
